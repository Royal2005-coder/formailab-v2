        ...
        items: [
          {
            ...
            href: `/workspaces/${workspace.id}/ai-lab-survey`,
            icon: FileSpreadsheetIcon,
            isActive: pathname === `/workspaces/${workspace.id}/ai-lab-survey`,
            isHidden: false,
        ...
        items: [
          {
            ...
            icon: MessageCircle,
            isActive: pathname?.includes("/surveys") && !pathname?.includes("/ai-lab-survey"),
            isHidden: false,
            disabled: isMembershipPending || isBilling,
          },
          {
