...
export const AI_LAB_KEYCLOAK_CLIENT_ID = process.env.AI_LAB_KEYCLOAK_CLIENT_ID;
export const AI_LAB_KEYCLOAK_CLIENT_SECRET = process.env.AI_LAB_KEYCLOAK_CLIENT_SECRET;
export const AI_LAB_KEYCLOAK_ISSUER = process.env.AI_LAB_KEYCLOAK_ISSUER;
export const AI_LAB_KEYCLOAK_ENABLED = !!(
...
export const IS_STORAGE_CONFIGURED = true;
