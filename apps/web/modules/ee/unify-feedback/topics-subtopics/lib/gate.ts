 ...
 * Lowered from 750 to 500 so datasets with moderate feedback volume (e.g. 565 records)
 * can access Topics & Subtopics without hitting the "not enough feedback" gate. */
export const MIN_OPEN_TEXT_RECORDS = 500;
