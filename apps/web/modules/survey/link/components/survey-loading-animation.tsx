...
export const SurveyLoadingAnimation = ({
  ...
  useEffect(() => {
    // Ensure animation is shown for max 2.5s fallback to prevent stuck spinners
  ...
  return (
    <div
      className={cn(
        "absolute inset-0 z-5000 flex items-center justify-center transition-all duration-500",
        isReadyToTransition ? "pointer-events-none bg-transparent opacity-0" : "bg-white opacity-100",
        isHidden && "hidden"
      )}>
      <div
        className={cn(
