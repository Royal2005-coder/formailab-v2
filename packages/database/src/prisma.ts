...
export type {
  ...
  AILabSurveyRegistry,
  AILabSurveyVersion,
  AILabSurveyPublication,
  AILabSurveyImportJob,
  SurveyQuota,
  ResponseQuotaLink,
  SurveyFollowUp,
  ActionClass,
...
export namespace Prisma {
  ...
  export type AILabSurveyRegistryGetPayload<
    S extends boolean | null | undefined | PrismaModelTypes.AILabSurveyRegistryDefaultArgs,
  > = PrismaModelTypes.AILabSurveyRegistryGetPayload<S>;
  export type AILabSurveyVersionGetPayload<
    S extends boolean | null | undefined | PrismaModelTypes.AILabSurveyVersionDefaultArgs,
  > = PrismaModelTypes.AILabSurveyVersionGetPayload<S>;
