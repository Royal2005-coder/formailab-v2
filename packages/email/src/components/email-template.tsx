  ...
  supported-color-schemes: light;
      ...
      <Tailwind>
        <Body
          ...
          <Section>
            {isDefaultLogo ? (
              <Link href={customLogoLink ?? logoLink} target="_blank">
          ...
          <Section className="mt-4 text-center text-sm">
            <Link
              ...
              href={customLogoLink ?? "https://formbricks.com/?utm_source=email_header&utm_medium=email"}
              target="_blank"
